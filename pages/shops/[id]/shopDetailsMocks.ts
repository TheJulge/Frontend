export const shopNoticesData = {
  ...
  items: [
    ...
    {
      item: {
        id: '254c0e94-de48-438e-b26b-bd0a84a99394',
        hourlyPay: 10000,
        startsAt: '2023-09-14T18:00:00.000Z',
        workhour: 4,
        description: '테스트',
      ...
      links: [
        {
          ...
          description: '공고 정보',
          method: 'GET',
          href: '/api/0-1/the-julge/shops/4490151c-5217-4157-b072-9c37b05bed47/notices/254c0e94-de48-438e-b26b-bd0a84a99394',
        },
        {
          rel: 'update',
          description: '공고 수정',
